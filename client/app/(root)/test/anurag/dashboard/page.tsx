...
import { bgColors, serverUrl } from "@/app/utils/utils";
import { ToastContainer, toast } from "react-toastify";
import { AiFillCheckCircle, AiFillSetting, AiOutlineFileDone } from "react-icons/ai";
import Section from "@/app/components/Animate";
										...
										<div
											style={{
												background: `linear-gradient(45deg, ${
													bgColors[item?.title.toString().toLowerCase()[0]][0]
												}, ${bgColors[item?.title.toString().toLowerCase()[0]][1]})`,
											}}
											className={"flex items-center justify-center w-full h-full opacity-50"}
										>
											<AiOutlineFileDone
												style={{ color: bgColors[item?.title.toString().toLowerCase()[0]][1] }}
