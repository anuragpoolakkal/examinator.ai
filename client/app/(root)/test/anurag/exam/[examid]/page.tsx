...
import { FiCheckCircle, FiUpload, FiDownload } from "react-icons/fi";
		...
		<div>
			...
			<div className="flex flex-col p-5">
				<div className="flex items-center mb-10 justify-between">
					...
					<div className="flex">
						<button
							...
							onClick={() => (window.location.href = `/review/${valuatorId}`)}
						>
							<FiCheckCircle /> Review Answer Sheets
						</button>
						<button
							className="btn btn-primary btn-md"
							onClick={() => (window.location.href = `/marksheet/${valuatorId}`)}
						>
				...
				<h3 className="text-xl font-bold mb-5 flex items-center">
					<FiDownload className="mr-2" /> Download question paper
				</h3>

				<h3 className="text-xl font-bold mb-5 flex items-center">
					<FiDownload className="mr-2" /> Download answer key
				</h3>
				...
				<div className="modal-box max-w-2xl align-middle">
					...
					<div className="my-10 flex flex-col items-center justify-center">
						...
						<p className="text-lg mb-5">
							Valuating Answer Sheet {currentValuatingSheet} of {answerSheets?.length}
						</p>
						<progress
							className="progress mb-5 w-[20vw]"
							value={(currentValuatingSheet / answerSheets?.length) * 100}
							max="100"
						></progress>
					</div>
				</div>
