		...
		<main className="flex items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tr from-[#6c63ff] to-[#20bee9]">
			<div className="backdrop-filter backdrop-blur-lg text-white">
				<div className="flex flex-col items-center text-white">
					<h1 className="text-6xl font-extrabold mb-4 text-gradient animate-fade-in">Examinator.AI</h1>
					<p className="text-2xl mb-8 text-opacity-80">Exam Management & Evaluation using AI</p>
					<button
				...
				<div className="mt-16 mx-auto max-w-screen-lg grid grid-cols-1 md:grid-cols-2 gap-8">
					<div className="card backdrop-filter backdrop-blur-lg bg-opacity-20	 bg-base-100 border-b border-gray-200">
						<div className="card-body text-black">
							<h2 className="card-title text-3xl font-bold mb-5">Valuating answer sheets made easy</h2>
							<ul className="list-disc pl-6">
								<li className="mb-2">
									🤖 Create exam valuators by uploading question papers and criteria
								</li>
								<li className="mb-2">📄 Bulk upload answer sheets and let AI value them</li>
					...
					<div className="card backdrop-filter backdrop-blur-lg bg-opacity-20 bg-base-100 border-b border-gray-200">
						<div className="card-body text-black">
							<h2 className="card-title text-3xl font-bold mb-5">Generate marklists with ease</h2>
							<ul className="list-disc pl-6">
								<li className="mb-2">📝 Generate marklists for each exam</li>
								<li className="mb-2">📄 Export marklists as CSV files</li>
								<li className="mb-2">📊 View overall statistics for each exam</li>
							</ul>
						</div>
					</div>
